...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("SELECT new com.money.manager.webapp.dto.CategoryStatDTO(t.category.name, t.category.color, SUM(t.amount)) " +
            "FROM Transaction t " +
    ...
    List<Transaction> findTransactionsAfterDate(@Param("userId") Long userId, @Param("startDate") LocalDate startDate);
}
